...
const LISTA_PRODUCTOS_ORIGINAL = [
    ...
    new Producto("Flecha", "img/flecha.png", 100, RAREZA.RARA, TIPO_PRODUCTO.ARMA, 25),
    new Producto("Hacha", "img/hacha.png", 500, RAREZA.LEGENDARIA, TIPO_PRODUCTO.ARMA, 40),
    new Producto("Escudo", "img/escudo.png", 300, RAREZA.COMUN, TIPO_PRODUCTO.ARMA, 25),
    new Producto("Casco", "img/casco.png", 200, RAREZA.RARA, TIPO_PRODUCTO.ARMA, 20),
