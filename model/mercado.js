...
const LISTA_PRODUCTOS_ORIGINAL = [
    ...
    new Producto("Flecha", "../img/productos/flecha.jpg", 1200, RAREZA.RARA, TIPO_PRODUCTO.ARMA, 25),
    ...
    new Producto("Casco", "../img/productos/casco.jpg", 1000, RAREZA.RARA, TIPO_PRODUCTO.ARMADURA, 20),
